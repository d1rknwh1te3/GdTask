...
internal static class RuntimeHelpersAbstraction
{
	...
	public static bool IsWellKnownNoReferenceContainsType<T>() => WellKnownNoReferenceContainsType<T>.IsWellKnownType;
	...
	private static bool WellKnownNoReferenceContainsTypeInitialize(Type t)
	{
		...
		if (t.IsGenericType && t.GetGenericTypeDefinition() == typeof(Nullable<>))
			return WellKnownNoReferenceContainsTypeInitialize(t.GetGenericArguments()[0]); // TODO: recursive call ???
